...
export default function ContactSection() {
  return (
    <section id="contact" className="py-24 bg-brand-surface border-t border-brand-border-light">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <div>
            ...
            <div className="flex items-center gap-2 mb-8">
              ...
              <span className="text-xs text-brand-text-dim tracking-wider">Open to remote work</span>
            </div>
          ...
          <div className="space-y-3">
            {[
              ...
              <div key={item.label} className="flex items-center gap-4 p-4 border border-brand-border-light rounded-sm hover:border-brand-border-light-light hover:bg-brand-card transition-all group">
                <div className="w-9 h-9 bg-brand-card border border-brand-border-light rounded-sm flex items-center justify-center shrink-0 text-brand-orange">
                  {item.icon}
                </div>
                <div className="flex-1 min-w-0">
                  <p className="text-xs text-brand-text-dim mb-0.5">{item.label}</p>
                  {item.href
                ...
                {item.href && <ArrowUpRight size={14} className="text-brand-subtle group-hover:text-brand-text-dim transition-colors shrink-0" />}
              </div>
            ))}
          </div>
        </div>
